-- LEGACY NATIVE FIXTURE SCHEMA.
-- v13.27 BE-centered docker-compose.yml does not mount this file.
-- It remains only for historical regression tests/backends and must not be
-- applied to the shared Spring BE database.
